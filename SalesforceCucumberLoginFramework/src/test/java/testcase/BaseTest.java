package testcase;
	...
	public class BaseTest {
		...
		protected static ExtentReports report=ExtentReports.getInstance();
		...
		public static void launchbrowser(String browserName) {
			...
			case "firefox":
				...
				mylog.info("firefox browser is launched");
				break;
			case "chrome":
				driver = new ChromeDriver();
				mylog.info("Chrome browser is launched");
				break;
			case "safari":
				driver = new SafariDriver();
				mylog.info("Safari browser is launched");
				break;
			default:
				mylog.info("You have not entered the Browser Name");
				break;
			}
		...
		public static void selectTextByData(WebElement element, String text, String objName) {
			waitforVisibilty(element, 10, objName);
		...
		{
			waitforVisibilty(element, 10, objectName);
			Select selectElement = new Select(element);
