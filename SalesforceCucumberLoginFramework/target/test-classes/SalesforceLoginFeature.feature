...
Background:
Given launch salesforce application with given url "https://login.salesforce.com/"
...
And user enters "garimas@tekarch.com" in username field
...
Scenario: implementing testcase4B User enters invalid username and invalid password
 ...
 And user enters "123123" for password field
 And user click on the login button
